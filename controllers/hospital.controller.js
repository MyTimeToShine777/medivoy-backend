...
class HospitalController {
  ...
  static async addDoctor(req, res) {
    try {
      ...
      return handleDatabaseError(error, res, 'Failed to add doctor to hospital');
    }
  }
  ...
  static async removeDoctor(req, res) {
    try {
      ...
      return handleDatabaseError(error, res, 'Failed to remove doctor from hospital');
    }
  }
  ...
  static async addTreatment(req, res) {
    try {
      ...
      return handleDatabaseError(error, res, 'Failed to add treatment to hospital');
    }
  }
