...
class AppointmentController {
  ...
  static async updateAppointmentStatus(req, res) {
    try {
      ...
      return handleDatabaseError(error, res, 'Failed to update appointment status');
    }
  }
  ...
  static async rescheduleAppointment(req, res) {
    try {
      ...
      return handleDatabaseError(error, res, 'Failed to reschedule appointment');
    }
  }
  ...
  static async getPatientAppointments(req, res) {
    try {
      ...
      return handleDatabaseError(error, res, 'Failed to retrieve patient appointments');
    }
  }
