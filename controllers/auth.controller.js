...
class AuthController {
  ...
  static async register(req, res) {
    try {
      ...
      try {
        ...
        logger.warn('Database not available, proceeding with mock registration');
      }
      ...
      const emailVerificationDisabled = process.env.EMAIL_VERIFICATION_DISABLED === 'true';
      ...
      return successResponse(
        res,
        {
          message: emailVerificationDisabled ? 'User registered and logged in successfully' : 'User registered successfully',
          data: {
            user: {
              id: user.id,
              email: user.email,
      ...
      try {
        ...
        if (email === 'testuser@example.com' && password === 'Password123!') {
          ...
          const mockUser = {
            ...
            password: '$2a$12$87hKZ2rj3kNwmctb3gICEOXJ7YN.EotpIlgdqfXfvfbz.zCkX7vm.', // Hashed version of "Password123!"
          };
  ...
  static async forgotPassword(req, res) {
    try {
      ...
      return handleDatabaseError(error, res, 'Failed to process password reset request');
    }
  }
  ...
  static async resendVerification(req, res) {
    try {
      ...
      return handleDatabaseError(error, res, 'Failed to resend verification email');
    }
  }
}
