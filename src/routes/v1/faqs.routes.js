...
router.post('/', auth, authorize(['admin']), faqController.createFAQ);
...
router.put('/:id', auth, authorize(['admin']), faqController.updateFAQ);

// Delete FAQ (admin only)

// Delete FAQ (admin only)
router.delete('/:id', auth, authorize(['admin']), faqController.deleteFAQ);
