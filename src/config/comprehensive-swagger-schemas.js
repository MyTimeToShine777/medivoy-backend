...
const comprehensiveSchemas = {
      ...
      data: {
        ...
        properties: {
          ...
          token: { 
            ...
            example: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwidXNlcm5hbWUiOiJqb2huZG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c"
          },
          refreshToken: { 
            type: "string",
  ...
  Appointment: {
    ...
    properties: {
      ...
      appointmentType: {
        type: "string",
        enum: ["consultation", "follow_up", "emergency", "routine_checkup", "procedure"],
  ...
  Doctor: {
    ...
    properties: {
      ...
      bio: {
        ...
        example: "Dr. Sarah Smith is a board-certified cardiologist with over 15 years of experience..."
      },
      languages: {
        type: "array",
  ...
  Hospital: {
    ...
    properties: {
      ...
      description: {
        ...
        example: "Leading multi-specialty hospital providing comprehensive healthcare services"
      },
      email: {
        type: "string",
        format: "email",
      ...
      facilities: {
        ...
        example: ["Emergency Room", "ICU", "Operating Theaters", "Laboratory", "Pharmacy"]
      },
      accreditations: {
        type: "array",
