...
Treatment.belongsTo(TreatmentSubcategory, {
...
TreatmentCategory.hasMany(TreatmentSubcategory, {
  foreignKey: "category_id",
  as: "subcategories",
});
...
TreatmentSubcategory.belongsTo(TreatmentCategory, {
  foreignKey: "category_id",
  as: "category",
});
TreatmentSubcategory.hasMany(Treatment, {
  foreignKey: "subcategory_id",
  as: "treatments",
});
...
Booking.hasMany(ChatConversation, {
  foreignKey: "booking_id",
  as: "conversations",
});
...
Appointment.hasMany(ChatConversation, {
  foreignKey: "appointment_id",
  as: "conversations",
});
Appointment.hasMany(VideoCall, {
  foreignKey: "appointment_id",
  as: "videoCalls",
});
...
HospitalDoctor.belongsTo(Hospital, {
  foreignKey: "hospital_id",
  as: "hospital",
});
HospitalDoctor.belongsTo(Doctor, { foreignKey: "doctor_id", as: "doctor" });

HospitalTreatment.belongsTo(Hospital, {
  foreignKey: "hospital_id",
  as: "hospital",
});
HospitalTreatment.belongsTo(Treatment, {
  foreignKey: "treatment_id",
  as: "treatment",
});
...
ChatConversation.belongsTo(Booking, {
  foreignKey: "booking_id",
  as: "booking",
});
ChatConversation.belongsTo(Appointment, {
  foreignKey: "appointment_id",
  as: "appointment",
});
...
ChatConversation.hasMany(VideoCall, {
  foreignKey: "conversation_id",
  as: "videoCalls",
});
...
VideoCall.belongsTo(Appointment, {
  foreignKey: "appointment_id",
  as: "appointment",
});
VideoCall.belongsTo(ChatConversation, {
  foreignKey: "conversation_id",
  as: "conversation",
});
...
TermsConditions.belongsTo(User, {
